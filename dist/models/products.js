...
var AllProducts = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        connection = _a.sent();
                        text = "INSERT INTO products(name, price, category) VALUES($1, $2, $3) RETURNING *";
    ...
    AllProducts.prototype.showProduct = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        throw new Error("Could not find products by ".concat(category, ", Error: ").concat(error_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    AllProducts.prototype.update = function (id, name, price, category) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, sql, values, result, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        error_5 = _a.sent();
                        throw new Error("Could not update product ".concat(id, ". Error: ").concat(error_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
